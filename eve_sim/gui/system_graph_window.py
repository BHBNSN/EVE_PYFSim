...
class _SystemGraphCanvas(QWidget):
    _MARGIN_PX = 42.0
    ...
    def __init__(self, owner: "SystemGraphWindow", parent: QWidget | None = None) -> None:
    ...
    def _map_definition(self):
        return getattr(self._owner.engine.world, "map_definition", None)
    ...
    def mousePressEvent(self, event) -> None:
        ...
        if system_id:
            self._owner.jump_to_system(system_id)
    ...
    def paintEvent(self, event) -> None:
        ...
        try:
            ...
            current_system_id = str(self._owner.current_system_getter() or "")
...
class SystemGraphWindow(QWidget):
    def __init__(
        ...
        self.canvas = _SystemGraphCanvas(self, self)
        layout.addWidget(self.canvas, 1)

    def sync_from_world(self) -> None:
        self.canvas._layout_cache_signature = None
        self.canvas.update()
